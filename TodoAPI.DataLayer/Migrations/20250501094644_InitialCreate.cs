        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryPublicId = table.Column<Guid>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TodoItemId = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    TodoItemPublicId = table.Column<Guid>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_CategoryPublicId",
                table: "Categories",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TodoItems_TodoItemPublicId",
                table: "TodoItems",
                column: "TodoItemPublicId",
                unique: true);
